...
class CreateEPayCheckCheckDetailsArchivedTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('e_pay_check_check_details_archived', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('e_pay_check_check_details_archived');
    }
}
