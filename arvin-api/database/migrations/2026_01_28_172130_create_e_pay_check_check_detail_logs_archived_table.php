...
class CreateEPayCheckCheckDetailLogsArchivedTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('e_pay_check_check_detail_logs_archived', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('rejected_addtional_remarks')->nullable(); // For transmitted status
            $table->boolean('rejected_status')->nullable(); // For transmitted status
            ...
            $table->string('received_by',50)->nullable(); // For transmitted status
    ...
    {
        Schema::dropIfExists('e_pay_check_check_detail_logs_archived');
    }
}
