...
class CreateUserAccessSubComponentRightsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_access_sub_component_rights', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('user_access_sub_component_rights');
    }
}
