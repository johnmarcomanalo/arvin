...
let CustomerRights = (props) => {
  const { ...customerRights } = CustomerRightsHooks(props);
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} md={12}>
                    ...
                    >
                      <ButtonComponent
                        click={() => {
                          customerRights.onClickOpenViewModal();
                        }}
                        iconType="view"
                        type="button"
                      >
          ...
          <Grid item xs={12} sm={12} md={10} lg={10}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={12} md={12} lg={12}>
                <Table
                  columns={customerRights.columns}
                  dataList={customerRights.dataList}
                  page={customerRights.page}
                  rowsPerPage={customerRights.rowsPerPage}
                  handleChangePage={customerRights.handleChangePage}
                  handleChangeRowsPerPage={
                    customerRights.handleChangeRowsPerPage
                  }
                  onSelectItem={customerRights.onSelectItem}
                  id={"page_rights_table"}
                  localStorage={""}
                  rowCount={customerRights.searchdataListCount}
                  action={(row) => {
                    ...
                    return (
                      <FormControl size="small" fullWidth>
                        ...
                        <Select
                          ...
                          value={access_rights}
                          onChange={(e) => {
                            customerRights.onUpdateEmployeeCustomerAccess(
                              row,
                              e.target.value
                            );
                          }}
