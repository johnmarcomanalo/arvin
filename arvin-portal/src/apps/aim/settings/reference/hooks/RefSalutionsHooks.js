...
import { getReferenceSalutations } from "../actions/ReferenceActions";
import moment from "moment";
import { Constants } from "../../../../../reducer/Contants";
const RefSalutationsHooks = (props) => {
  ...
  const getRefSalutations = async () => {
    try {
      const data = getListParam();
      await dispatch(getReferenceSalutations(data));
    } catch (error) {
...
export default RefSalutationsHooks;
