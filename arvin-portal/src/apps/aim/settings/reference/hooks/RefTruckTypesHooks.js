...
import { getReferenceTruckTypes } from "../actions/ReferenceActions";
import swal from "sweetalert";
const RefTruckTypesHooks = (props) => {
  ...
  const columns = [
    ...
    { id: "capacity", label: "Capacity (kg)", align: "left" },
  ];
  ...
  const getRefUnitOfMeasurements = async () => {
    try {
      ...
      await dispatch(getReferenceTruckTypes(data));
    } catch (error) {
...
export default RefTruckTypesHooks;
