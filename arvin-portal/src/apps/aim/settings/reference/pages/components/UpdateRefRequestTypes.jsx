...
import { putRefRequestTypes } from "../../actions/ReferenceActions";
import swal from "sweetalert";
import { Constants } from "../../../../../../reducer/Contants";
const formName = "UpdateRefRequestTypes";
const submit = async (values, dispatch, props) => {
  try {
    const res = await dispatch(putRefRequestTypes(values));
    await dispatch({
...
let UpdateRefRequestTypes = (props) => {
  const { ...param } = props;
