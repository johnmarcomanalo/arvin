...
import { putRefProductGroups } from "../../actions/ReferenceActions";
import swal from "sweetalert";
import { Constants } from "../../../../../../reducer/Contants";
const formName = "UpdateRefProductGroups";
const submit = async (values, dispatch, props) => {
  try {
    const res = await dispatch(putRefProductGroups(values));
    await dispatch({
...
let UpdateRefProductGroups = (props) => {
  const { ...param } = props;
  ...
  React.useEffect(() => {
    props.initialize({
      ...
      unit_conversion: selected_ref?.unit_conversion,
    });
