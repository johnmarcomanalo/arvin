...
import {
  getBankChecCounterData, 
} from "../actions/BankCheckCounterActions";
...
const BankCheckCounterHooks = (props) => {
     ...
     const GetChequeList = async () => {
       try {
         const data = getListParam();
          await debounce(() => { 
            dispatch(getBankChecCounterData(data));
         }, state.debounceDelay);
       } catch (error) {
...
export default BankCheckCounterHooks;
